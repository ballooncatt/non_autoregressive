...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def forward(
        ...
        # modify
        assert self.is_causal is False
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        # )
        causal_mask = self._update_causal_mask(attention_mask, inputs_embeds, cache_position,  past_key_values, output_attentions, is_causal=False) # Modify: MDM
